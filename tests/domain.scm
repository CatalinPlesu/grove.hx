...
(define flat-tree
  (tree.build
   (list
    (file "item-00") (file "item-01") (file "item-02")
    (file "item-03") (file "item-04") (file "item-05")
    (file "item-06") (file "item-07") (file "item-08")
    (file "item-09") (file "item-10") (file "item-11"))))

(define flat-rows
  (rows.build
   ROOT flat-tree (git.build '()) '() #f
   (expansion.empty)
   #f))
