...
(provide geometry geometry-width
         resolve scroll-by scroll-to reveal
         x y width height side
         pane-slots ordinary-capacity
         slot-row slot-pinned?
         rail-x rail-part-at
         rail-thumb-offset rail-resize-width
         rail-scroll-offset rail-scroll-limit rail-page-amount)
