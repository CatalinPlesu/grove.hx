...
(define (current-styles icons?)
  ...
  (define background-style
    (materialize-style
     background-scope text-foreground-color grove-background-color))
  (define text-style
    (materialize-style
     text-scope text-foreground-color grove-background-color))
  (define pinned-style
    (style-bg
     text-style
  ...
  (define cursor-style
    (materialize-style
     cursor-source
     text-foreground-color grove-background-color))
  ...
  (define rail-track-style
    (glyph-style
     scroll-scope rail-track-color grove-background-color))
  (define rail-thumb-style
    (glyph-style
     scroll-scope rail-thumb-color grove-background-color))
  ...
  (line.styles
   ...
   #:text text-style
   #:cursor cursor-style
   #:active-file active-file-style
   #:pinned pinned-style
   #:rail-track rail-track-style
   #:rail-thumb rail-thumb-style
   #:error (scope-foreground "error")
   #:deleted (scope-foreground "diff.minus")
   #:modified (scope-foreground "diff.delta")
   #:created (scope-foreground "diff.plus")
   #:unsaved (scope-foreground "info")
   #:icon-palette
   (and
    icons?
